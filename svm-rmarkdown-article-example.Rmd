...
thanks: "Replication files are available on the author's Github account (http://github.com/sf585978). **Current version**: `r format(Sys.time(), '%B %d, %Y')`; **Corresponding author**: sean.fischer@asc.upenn.edu."
author:
- name: Sean Fischer
  affiliation: Annenberg School for Communication, The University of Pennsylvania
...
fontsize: 11pt
# spacing: double
bibliography: ../mendeley/references/fischerbib.bib
biblio-style: apsr
endnote: no
---
